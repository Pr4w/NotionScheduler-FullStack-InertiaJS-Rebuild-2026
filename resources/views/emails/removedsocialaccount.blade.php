...
If you still plan on using this social media account with NotionScheduler,  head over to the <a href="https://app.notionscheduler.app">NotionScheduler Dashboard</a> to re-connect it and ensure that your scheduled posts can be posted successfully.
