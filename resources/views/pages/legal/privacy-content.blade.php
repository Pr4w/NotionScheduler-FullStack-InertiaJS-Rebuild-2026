...
<h1>Privacy Policy</h1>
        ...
        <ul>
            ...
            <li>
                <p>
                    ...
                    Mark Hadj Hamou, 99 avenue du General Leclerc, 94700 Maisons Alfort.
                </p>
            </li>
            <li>
                <p>
            ...
            <li>
                <p>
                    <strong>Website</strong> refers to Notion Scheduler, accessible from
                    <a
        ...
        <ul>
            <li>
                ...
                <a
                    href="https://notionscheduler.app/app/support"
                    rel="external nofollow noopener"
                    target="_blank"
                    >https://notionscheduler.app/app/support</a
                >
            </li>
        </ul>
@endverbatim
